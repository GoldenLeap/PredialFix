 ...
 * @route '/livewire-13932653/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-13932653/livewire.js',
 ...
 * @route '/livewire-13932653/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-13932653/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-13932653/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-13932653/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
