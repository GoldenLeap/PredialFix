 ...
 * @route '/livewire-26cd0509/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-26cd0509/livewire.js',
 ...
 * @route '/livewire-26cd0509/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-26cd0509/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-26cd0509/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-26cd0509/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
