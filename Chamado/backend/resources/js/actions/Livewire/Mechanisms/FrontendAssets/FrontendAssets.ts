 ...
 * @route '/livewire-901188fe/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-901188fe/livewire.js',
 ...
 * @route '/livewire-901188fe/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-901188fe/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-901188fe/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-901188fe/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
