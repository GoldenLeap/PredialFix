...
* @route '/livewire-d60ff4ea/livewire.js'
*/
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d60ff4ea/livewire.js',
...
* @route '/livewire-d60ff4ea/livewire.min.js.map'
*/
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-d60ff4ea/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
...
* @route '/livewire-d60ff4ea/livewire.csp.min.js.map'
*/
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-d60ff4ea/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
