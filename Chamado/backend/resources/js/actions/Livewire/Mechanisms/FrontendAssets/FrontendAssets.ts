 ...
 * @route '/livewire-e9875027/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-e9875027/livewire.js',
 ...
 * @route '/livewire-e9875027/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-e9875027/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-e9875027/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-e9875027/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
