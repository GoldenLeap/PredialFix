 ...
 * @route '/livewire-a283ac62/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-a283ac62/livewire.js',
 ...
 * @route '/livewire-a283ac62/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-a283ac62/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-a283ac62/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-a283ac62/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
