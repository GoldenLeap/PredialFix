 ...
 * @route '/livewire-e9875027/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-e9875027/upload-file',
 ...
 * @route '/livewire-e9875027/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-e9875027/preview-file/{filename}',
