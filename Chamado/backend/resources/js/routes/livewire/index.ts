 ...
 * @route '/livewire-26cd0509/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-26cd0509/upload-file',
 ...
 * @route '/livewire-26cd0509/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-26cd0509/preview-file/{filename}',
