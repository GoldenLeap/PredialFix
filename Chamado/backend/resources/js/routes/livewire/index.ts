 ...
 * @route '/livewire-a283ac62/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-a283ac62/upload-file',
 ...
 * @route '/livewire-a283ac62/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-a283ac62/preview-file/{filename}',
