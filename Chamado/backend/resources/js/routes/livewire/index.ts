...
* @route '/livewire-d60ff4ea/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-d60ff4ea/upload-file',
...
* @route '/livewire-d60ff4ea/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-d60ff4ea/preview-file/{filename}',
