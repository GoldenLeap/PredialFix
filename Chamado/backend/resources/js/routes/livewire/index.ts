 ...
 * @route '/livewire-6a892ab8/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-6a892ab8/upload-file',
 ...
 * @route '/livewire-6a892ab8/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-6a892ab8/preview-file/{filename}',
