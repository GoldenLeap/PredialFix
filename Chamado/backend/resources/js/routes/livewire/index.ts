 ...
 * @route '/livewire-13932653/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-13932653/upload-file',
 ...
 * @route '/livewire-13932653/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-13932653/preview-file/{filename}',
