 ...
 * @route '/livewire-1a18198b/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-1a18198b/upload-file',
 ...
 * @route '/livewire-1a18198b/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-1a18198b/preview-file/{filename}',
