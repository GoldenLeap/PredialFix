...
* @route '/livewire-774a6b4f/upload-file'
*/
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-774a6b4f/upload-file',
...
* @route '/livewire-774a6b4f/preview-file/{filename}'
*/
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-774a6b4f/preview-file/{filename}',
