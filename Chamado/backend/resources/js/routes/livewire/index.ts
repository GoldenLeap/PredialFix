 ...
 * @route '/livewire-901188fe/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-901188fe/upload-file',
 ...
 * @route '/livewire-901188fe/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-901188fe/preview-file/{filename}',
