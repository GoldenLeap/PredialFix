...
const form = useForm({
    ...
    quantidade_atual: props.material.quantidade_atual,
    quantidade_minima: props.material.quantidade_minima,
    unidade: props.material.unidade,
    valor_unitario: props.material.valor_unitario,
    localizacao: props.material.localizacao || '',
});

const submit = () => {
    form.put(`/materiais/${props.material.id}`);
};
</script>
        ...
        <div class="max-w-3xl mx-auto flex flex-col gap-6 animate-in fade-in slide-in-from-bottom-3 duration-500">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground mt-1">Atualize as informações do insumo no estoque.</p>
                </div>
            </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-2 md:col-span-2">
                            ...
                            <input type="text" v-model="form.nome" required class="w-full bg-muted border border-border rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary outline-none transition-all">
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" v-model="form.localizacao" class="w-full bg-muted border border-border rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-primary outline-none transition-all">
                        </div>
                    </div>
